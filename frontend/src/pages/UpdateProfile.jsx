...
const UpdateProfile = () => {
  ...
  const inputClasses = "text-black-500 mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out";
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <motion.div variants={slideIn} transition={{ delay: 0.7, duration: 0.5 }}>
                  ...
                  <input
                    ...
                    type="email"
                    required
                    className={`${inputClasses} bg-black text-black-500`}
                    onChange={handleChange}
                  />
                </motion.div>
